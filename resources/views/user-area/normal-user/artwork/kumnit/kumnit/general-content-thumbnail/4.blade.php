...
@section('css')
  ...
  <style>
    ...
    .artwork-preview .title {
      ...
      font-size: 4vw;
      text-shadow: 0.25vw 0.25vw 0 rgba(0, 0, 0, 0.25);
    }
    ...
    #download .artwork-preview .title {
      font-size: 28vw;
      text-shadow: 1.75vw 1.75vw 0 rgba(0, 0, 0, 0.25);
    }
    #download-overlay {
      width: 616vw;
      height: 322.5130890052vw;
    ...
    @media (min-width: 800px) {
      ...
      .customized-container .artwork-preview .title {
        ...
        text-shadow: 0.1022727273vw 0.1022727273vw 0 rgba(0, 0, 0, 0.25);
      }
    }
  </style>
@endsection
  ...
  $('#logo').on('change', function(){
      ...
      if(name == 'kumnit') {
        ...
        $('.overlay').each(function(){
          this.style.background = 'linear-gradient(0deg, #2857a5, rgba(40, 87, 165, 0))'
        })
      }
      else {
        $('.overlay').each(function(){
          this.style.background = 'linear-gradient(0deg, rgba(27,68,114,1) 0%, rgba(27,68,114,0) 100%)'
        })
        if(name == 'ponlork') {
          $('.logo').each(function(){
      ...
      if(windowWidth < 800) {
        $('.title').each((i, obj) => {
          switch(i) {
            case 0 : {
              $(obj).css({
                'font-size' : `calc(4vw * 7 * (${titleFontSizePercentage} / 100))`,
              })             
            } break
            case 1 : {
              $(obj).css({
                'font-size' : `calc(4vw * (${titleFontSizePercentage} / 100))`,
              })             
            } break
          }
        })
        ...
        $('.title').each((i, obj) => {
          switch(i) {
            ...
            case 1 : {
              $(obj).css({
                'font-size' : `calc(4vw * 36 / 88 * (${titleFontSizePercentage} / 100))`,
              })             
            } break
          }
        })
