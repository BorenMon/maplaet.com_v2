  ...
  const fontSizePercentageChanger = () => {
    ...
    if(windowWidth < 800) {
      $('.primary-text').each((i, obj) => {
        switch(i) {
          case 0 : obj.style.fontSize = `calc(5.5vw * 7 * (${primaryTextFontSizePercentage} / 100))`; break
          case 1 : obj.style.fontSize = `calc(5.5vw * (${primaryTextFontSizePercentage} / 100))`; break
        }
      })
      $('.secondary-text').each((i, obj) => {
        switch(i) {
          case 0 : obj.style.fontSize = `calc(5.5vw * 7 * (${secondaryTextFontSizePercentage} / 100))`; break
          case 1 : obj.style.fontSize = `calc(5.5vw * (${secondaryTextFontSizePercentage} / 100))`; break
        }
      })
    } else {
      $('.primary-text').each((i, obj) => {
        switch(i) {
          case 0 : obj.style.fontSize = `calc(5.5vw * 7 * (${primaryTextFontSizePercentage} / 100))`; break
          case 1 : obj.style.fontSize = `calc((5.5vw * 36 / 88) * (${primaryTextFontSizePercentage} / 100))`; break
        }
      })
      $('.secondary-text').each((i, obj) => {
        switch(i) {
          case 0 : obj.style.fontSize = `calc(5.5vw * 7 * (${secondaryTextFontSizePercentage} / 100))`; break
          case 1 : obj.style.fontSize = `calc((5.5vw * 36 / 88) * (${secondaryTextFontSizePercentage} / 100))`; break
        }
      })
    }
  }
