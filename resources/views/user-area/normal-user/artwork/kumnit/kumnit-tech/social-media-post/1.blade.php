...
.artwork-preview .background-overlay {
  ...
  bottom: 0;
  left: 0;
  background: linear-gradient(135deg, rgba(40,87,165,1) 0%, rgba(10,62,137,1) 100%);
  opacity: 90%;
}
...
.artwork-preview .box .border-bottom {
    bottom: 0;
    left: 50%;
    transform: translateY(97%) translateX(-50%) scaleX(-1) scaleY(-1);
}
.artwork-preview .box .mark-bottom {
    --tw-scale-x: -1;
    --tw-scale-y: -1;
...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
  <div id="download">
    <div class="artwork-preview">
      <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/1/background.svg') }}" class="background">

      <div class="background-overlay hidden"></div>
      
      <img src="{{ asset('assets/kumnit/images/logo/default/kumnit-tech-logo.svg') }}" alt="" class="logo">

      <div class="box">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/1/quote.svg') }}" alt="" class="mark-top">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/1/border.svg') }}" alt="" class="border-top">
        <div class="quote">
          
        </div>
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/1/border.svg') }}" alt="" class="border-bottom">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/1/quote.svg') }}" alt="" class="mark-bottom">
      </div>
    </div>
  </div>
...
<script>
  ...
  document.getElementById('drag-drop').addEventListener('drop', function(e) {
    ...
    destroyCropper()
    $('.background').each(function() {
      bgImgSrc = URL.createObjectURL(file)
      this.src = bgImgSrc
    })
    $('#cropperImg').attr('src', bgImgSrc)
    closeUploadModal()
