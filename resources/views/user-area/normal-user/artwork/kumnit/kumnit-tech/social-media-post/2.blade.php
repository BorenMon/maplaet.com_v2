...
#download-overlay {
    ...
    .customized-container .artwork-preview .box {
        padding: 2.0454545455vw 2.8636363636vw;
    }
...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
  <div id="download">
    <div class="artwork-preview">
      <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/2/background.svg') }}" class="background">
      ...
      <div class="box">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/2/quote.svg') }}" alt="" class="mark-top">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/2/border.svg') }}" alt="" class="border-top">
        <div class="quote">
          
        </div>
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/2/border.svg') }}" alt="" class="border-bottom">
        <img src="{{ asset('assets/kumnit/images/kumnit-tech/social-media-post/2/quote.svg') }}" alt="" class="mark-bottom">
      </div>
    </div>
  </div>
