...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            @include('layouts.normal-user.navigation-menu')

            <!-- Page Heading -->
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-2xl font-semibold">
                    @yield('header')
                </div>
            </header>
        ...
        <script src="https://kit.fontawesome.com/6ce15ea8d9.js" crossorigin="anonymous"></script>
