...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-maplaet-1 text-base font-medium text-maplaet-1 bg-gray-50 focus:outline-none focus:text-maplaet-1 focus:bg-gray-100 focus:border-maplaet-1 transition'
